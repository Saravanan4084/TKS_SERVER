...
class SnowballFightGame(bs.TeamGameActivity[Player, Team]):
    ...
    def get_available_settings(
        ...
        settings = [
            ...
            bs.BoolSetting(icy_floor, default=False),  # Added Icy Floor setting
    ...
    def __init__(self, settings: dict):
        ...
        self._icy_floor = bool(settings[icy_floor])  # Added Icy Floor setting
